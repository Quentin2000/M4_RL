"""
This script demonstrates the environment for the M4 robot.

.. code-block:: bash

    # Run the script
    ./isaaclab.sh -p source/m4/basics/m4_base_env.py --num_envs 32
...
parser = argparse.ArgumentParser(description="Tutorial on creating the M4 robot base environment.")
...
from m4 import M4_CFG  # isort: skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # add robot
    robot: ArticulationCfg = M4_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class M4EnvCfg(ManagerBasedEnvCfg):
...
def main():
    ...
    while simulation_app.is_running():
        with torch.inference_mode():
            ...
            # print("[Env 0]: Joint: ", obs["policy"][:][:].item())
