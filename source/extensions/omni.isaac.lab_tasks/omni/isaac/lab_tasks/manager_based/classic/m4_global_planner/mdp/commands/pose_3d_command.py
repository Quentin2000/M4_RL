...
if TYPE_CHECKING:
    ...
    from .commands_cfg import UniformPose3dCommandCfg
...
class UniformPose3dCommand(CommandTerm):
    ...
    The command generator samples uniform 3D positions around the environment origin. It sets
    ...
    def __init__(self, cfg: UniformPose3dCommandCfg, env: ManagerBasedEnv):
