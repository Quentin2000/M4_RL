...
def last_elevation_action(env: ManagerBasedEnv, action_name: str | None = None) -> torch.Tensor:
    ...
    if action_name is None:
        return env.action_manager.action[:, 2]
    else:
        return env.action_manager.get_term(action_name).raw_actions[:, 2]
